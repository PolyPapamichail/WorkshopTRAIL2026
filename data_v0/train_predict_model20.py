...
# ============================================================
# MODEL 20
# Larger MLP + Mini-batch training + lower learning rate
# ============================================================
...
#
# Use previous 5 time steps
# to predict the next 5 target values.
#
# Therefore:
# 5 time steps × 12 features = 60 input features
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 16. Results by prediction horizon
# ------------------------------------------------------------
...
print("=================================")
print("PLOT SAVED:")
print("prediction_plot_model20.png")
print("=================================")